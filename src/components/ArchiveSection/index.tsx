		...
		<Section className="bg-orange flex inner">
			...
			<ul className="flex justify-between w-full mt-[5rem] ">
				<Link href="https://github.com/www-r">
					<li className="border border-solid mr-[3rem] mb-[2rem] bg-white  p-[1.5rem] w-[35rem] text-lg font-bold">
						<p>Github</p>
						<Image
				...
				<Link href="https://woorii-kye.tistory.com">
					<li className="border-solid border mr-[3rem] mb-[2rem] bg-white  p-[1.5rem] w-[35rem] text-lg font-bold">
						<p>Tistory</p>
						<Image
